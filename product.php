...
if (isset($_GET['product_id'])) {
  ...
  // Shuffle the data using ORDER BY RAND()
  $sql = "SELECT * FROM cards ORDER BY RAND() LIMIT 1"; // Limit to 1 to get a single random product
              ...
              <div class="row g-0">
                ...
                <div class="col-lg-4 bg-grey">
                  <div class="p-5">
                    ...
                    <button type="button" class="btn btn-dark btn-block btn-lg" data-mdb-ripple-color="dark" id="checkout-button" <?php if (!$userIsLoggedIn) echo 'disabled'; ?>>
                      Checkout
                    </button>
                    ...
                    <form method="POST" action="add_to_cart.php?product_id=<?php echo $productID; ?>">
                      ...
                      <button type="submit" class="btn btn-dark btn-block mt-1" name="addtocart" <?php if (!$userIsLoggedIn) echo 'disabled'; ?>>
                        Add to Cart
                      </button>
                    </form>
